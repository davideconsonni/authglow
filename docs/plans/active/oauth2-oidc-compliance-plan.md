...
- [ ] **[OA-205]** 2.5 `software_statement` DCR.
...
- [ ] **[OA-206]** 2.6 Done fase: zero deviazioni silenziose; ogni hardening residuo è in discovery/docs con test.
...
- [ ] **[OA-301]** 3.1 Risposta token first-party standard.
...
- [ ] **[OA-302]** 3.2 Codici errore conformi.
...
- [ ] **[OA-303]** 3.3 `c_hash` morto o vivo.
