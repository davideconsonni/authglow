...
- [x] **[OA-404]** 4.4 Done fase: zero MUST falliti (o waiver scritti e firmati in questo file).
...
- [x] **[OA-601]** 6.1 `ARCHITECTURE.md` + `docs/` per ogni endpoint toccato: parametri canonici, errori `error=`,
