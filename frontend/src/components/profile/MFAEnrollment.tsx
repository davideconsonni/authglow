      ...
      <div className="space-y-4">
        ...
        <form onSubmit={handleSubmit(onVerify)} className="space-y-4">
          ...
          <button
            ...
            className="btn-cta flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-cta px-4 py-3 text-sm font-semibold text-white shadow-glow-accent transition-all duration-150 hover:scale-[1.02] active:scale-[0.98]"
          >
